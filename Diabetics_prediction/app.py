...
def hello():
    if request.method=='POST':
        ...
        data = "apikey=" + 'XILOeRbCe1dbP_Y_HTUrKaHvB61P3IQ22j6VwYn9i3P1' + "&grant_type=urn:ibm:params:oauth:grant-type:apikey"
        ...
        response_scoring = requests.post(
            'https://us-south.ml.cloud.ibm.com/ml/v4/deployments/b182479b-49d4-4543-8273-d679c7cde91e/predictions?version=2020-10-17',
